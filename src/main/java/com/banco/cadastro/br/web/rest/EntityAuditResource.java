...
import com.banco.cadastro.br.domain.EntityAuditEvent;
import com.banco.cadastro.br.repository.EntityAuditEventRepository;
import com.banco.cadastro.br.security.AuthoritiesConstants;
...
public class EntityAuditResource {
    ...
    public List<AuditedEntityRecord> getAuditedEntities() {
        return entityAuditEventRepository.findAllEntityTypes().stream().map(e -> new AuditedEntityRecord(e, e)).toList();
    }
